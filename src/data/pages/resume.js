...
export const projects = {
  en: [
    ...
    {
      title: 'Podcast Agent Bot',
      description:
        "🤖 Discord bot that analyzes and summarizes podcasts using OpenAI's GPT and Whisper, providing insights and interactive Q&A based on the audio content.",
      link: 'https://www.youtube.com/watch?v=bBJazG26p0k',
      textKey: 'viewDemo',
      github: 'https://github.com/matiasvallejosdev/podcast-agent-gpt-discord-bot-ai',
      tags: [
        'Python',
        'Discord Bot',
        'OpenAI GPT',
      ...
      video: '/projects/movies/podcast-agent-bot.mp4',
      featured: true,
      category: 'ai',
      date: '2024-04-01',
    },
  ...
  es: [
    ...
    },
    {
      title: 'Podcast Agent Bot',
      description:
        '🤖 Bot de Discord que analiza y resume podcasts utilizando GPT y Whisper de OpenAI, proporcionando perspectivas e interacción de preguntas y respuestas basada en el contenido de audio.',
      link: 'https://www.youtube.com/watch?v=bBJazG26p0k',
      textKey: 'viewDemo',
      github: 'https://github.com/matiasvallejosdev/podcast-agent-gpt-discord-bot-ai',
      tags: [
...
export const skills = [
  {
    svgIcon: '/icons/skills/react.svg',
    name: 'React',
    description: 'JavaScript library for UIs.',
    category: 'frameworks',
  },
  {
    svgIcon: '/icons/skills/next.svg',
    name: 'Next.js',
    description: 'React framework for web apps.',
    category: 'frameworks',
  },
  {
    svgIcon: '/icons/skills/html5.svg',
    name: 'HTML',
    description: 'Markup language for web pages.',
    category: 'languages',
  },
  {
    svgIcon: '/icons/skills/css.svg',
    name: 'CSS',
    description: 'Style sheet language for web.',
    category: 'languages',
  },
  {
    svgIcon: '/icons/skills/js.svg',
    name: 'JavaScript',
    description: 'Scripting language for web pages.',
    category: 'languages',
  },
  {
    svgIcon: '/icons/skills/tailwindcss.svg',
    name: 'Tailwind CSS',
    description: 'Utility-first CSS framework.',
    category: 'frameworks',
  },
  {
    svgIcon: '/icons/skills/python.svg',
    name: 'Python',
    description: 'Interpreted language with clear syntax.',
    category: 'languages',
  },
  {
    svgIcon: '/icons/skills/django.svg',
    name: 'Django',
    description: 'High-level Python web framework.',
    category: 'frameworks',
  },
  {
    svgIcon: '/icons/skills/mysql.svg',
    name: 'MySQL',
    description: 'Relational database management system.',
    category: 'databases',
  },
  {
    svgIcon: '/icons/skills/postgresql.svg',
    name: 'PostgreSQL',
    description: 'Open-source relational database.',
    category: 'databases',
  },
  {
    svgIcon: '/icons/skills/dotnet.svg',
    name: '.NET',
    description: 'Platform for many types of apps.',
    category: 'frameworks',
  },
  {
    svgIcon: '/icons/skills/csharp.svg',
    name: 'C#',
    description: 'Simple, modern, and type-safe language.',
    category: 'languages',
  },
  { svgIcon: '/icons/skills/aws.svg', name: 'AWS', description: 'Cloud computing services.', category: 'cloud' },
  {
    svgIcon: '/icons/skills/unity.svg',
    name: 'Unity',
    description: 'Game engine for 2D and 3D games.',
    dark: '/icons/skills/unity_dark.svg',
    category: 'others',
  },
  { svgIcon: '/icons/skills/git.svg', name: 'Git', description: 'Version control system.', category: 'tools' },
  {
    svgIcon: '/icons/skills/notion.svg',
    name: 'Notion',
    description: 'Project management and note-taking tool.',
    category: 'tools',
  },
];
